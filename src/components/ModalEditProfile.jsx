...
const ModalEditProfile = ({ userInfo, refetch }) => {
  const { updateUserInfo, user, setLoading } = useAuth();
      ...
      <dialog id="my_modal_5" className="modal modal-bottom sm:modal-middle">
        <div className="modal-box">
          ...
          <form
            ...
            className="w-10/12 mx-auto border-2 p-6 border-accent rounded-xl"
          >
            {/* name */}
            ...
            <input
              className="btn btn-block btn-accent mt-3 text-white"
              type="submit"
