...
const AboutUs = () => {
  return (
    <div className="pt-24 w-10/12 mx-auto">
      <div className="flex flex-col justify-center items-center bg-yellow-100 pt-10 mt-10">
        ...
        <p className="font-serif font-semibold text-gray-400">
          shorgoshiam@gmail.com
        </p>
      </div>
      <div className="bg-yellow-200 min-h-72 -mt-60 mb-10 border-t-4 border-yellow-300 rounded-t-xl"></div>
